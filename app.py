...
# ors_client = Client(key='5b3ce3597851110001cf624882e76173985f4cfaa6282130d090ef18')
...
#     decorated_function.__name__ = f'auth_{f.__name__}'
...
#     requests = db_ref.child('collaboration_requests').child(user_id).get() or []
...
#     return render_template('collaboration.html', route_data=route_data, competitor_data=competitor_data)
...
#         total_co2 = total_distance * 200  # g/km
